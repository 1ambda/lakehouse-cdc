...
CREATE USER 'connect'@'%' IDENTIFIED WITH mysql_native_password BY 'debezium';
GRANT SELECT, RELOAD, SHOW DATABASES, REPLICATION SLAVE, REPLICATION CLIENT ON *.* TO 'connect';
FLUSH PRIVILEGES;
GRANT ALL PRIVILEGES ON inventory.* TO 'connect'@'%';
